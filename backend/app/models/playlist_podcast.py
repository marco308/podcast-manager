...
class PlaylistPodcast(Base):
    ...
    __table_args__ = (
        UniqueConstraint("playlist_id", "podcast_id", name="uq_playlist_podcast"),
    )
    ...
    def __repr__(self) -> str:
        return f"<PlaylistPodcast(playlist_id={self.playlist_id}, podcast_id={self.podcast_id}, position={self.position})>"
