        ...
        <Col xs={24} sm={12} lg={6}>
          <Card styles={{ body: { padding: isMobile ? 16 : 24 } }}>
            <Space direction="vertical" size={0} style={{ width: '100%' }}>
              <Text type="secondary" style={{ fontSize: isMobile ? 14 : 12 }}>Categories</Text>
              <div style={{ marginTop: 8, display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: 4, flexWrap: 'wrap' }}>
                  ...
                  <Space direction="vertical" size={4} style={{ width: '100%' }}>
                    ...
                    <Tag
                      color={
                        ...
                        playlist.rule_type === 'morning' ? 'orange' :
                    ...
                    {!playlist.is_enabled && (
                      <Tag color="default" style={{ width: 'fit-content' }}>Disabled</Tag>
                    )}
                  </Space>
                </Card>
              </Col>
